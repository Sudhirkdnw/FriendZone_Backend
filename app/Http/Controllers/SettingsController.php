...
class SettingsController extends Controller
{
    ...
    public function updateSettings(Request $request)
    {
        ...
        if ($setting) {
            ...
            if ($request->has('is_maintenance_mode')) {
            ...
            if ($request->has('ios_app_version')) {
                $setting->ios_app_version = $request->ios_app_version;
            }
            if ($request->has('is_force_app_update')) {
                $setting->is_force_app_update = $request->is_force_app_update;
            }
            $setting->save();
